...
from ..top_level import assert_not_contains
...
def test__assert_not_contains(value_0, value_1, keyword_parameters):
    """
    Tests whether ``assert_not_contains`` works as intended.
    ...
    """
    try:
        assert_not_contains(value_0, value_1, **keyword_parameters)
