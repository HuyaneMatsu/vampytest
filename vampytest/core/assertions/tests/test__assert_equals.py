...
from ..top_level import assert_equals
...
def test__assert_equals(value_0, value_1, keyword_parameters):
    """
    Tests whether ``assert_equals`` works as intended.
    ...
    """
    try:
        assert_equals(value_0, value_1, **keyword_parameters)
