...
from ..assertion_rendering import _produce_one_sided_operation
...
def test__produce_one_sided_operation(operation, highlighter):
    """
    Tests whether ``_produce_one_sided_operation`` works as intended.
    ...
    for item in _produce_one_sided_operation(operation):
